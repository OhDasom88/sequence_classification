...
def inference(data_dir, model_dir, output_dir, args):
    ...
    with open(os.path.join(output_dir, KLUE_NLI_OUTPUT), "w") as output_file:
    # for input_ids, attention_mask, token_type_ids, target in klue_nli_test_loader:
        for input_ids, attention_mask, token_type_ids in klue_nli_test_loader:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--data_dir", type=str, default='/home/dasomoh88/KLUE-Baseline/data/klue_benchmark/klue-nli-v1.1/'
    )
    parser.add_argument(
        # "--model_dir", type=str, default="./model"
        # "--model_dir", type=str, default="/home/dasomoh88/KLUE-Baseline/inference/model/"
        # "--model_dir", type=str, default="/home/dasomoh88/KLUE-Baseline/inference/temp/"
        "--model_dir", type=str, default="/home/dasomoh88/KLUE-Baseline/klue_output/klue-nli/version_0/transformers"
    )
    parser.add_argument(
        "--model_tar_file",
        type=str,
